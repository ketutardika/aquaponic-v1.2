...
@endif
                ...
                <form class="forms-sample" action="{{ route('crops.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="crop_name" value="{{ old('crop_name') }}" class="form-control @error('crop_name') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Crops Name">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="qty_plant" value="{{ old('qty_plant') }}" class="form-control @error('qty_plant') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="How Many Plants">
                                <!-- error message untuk title -->
                                @error('qty_plant')
                                <p class="mb-3">
                                    {{ $message }}
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="FarmBlock" class="form-label">Block Farm</label>
                                <select class="form-select" id="FarmBlock" name="farm_block">
                                    @foreach ($farmblocks as $farmblock)
                                    <option value="{{$farmblock->id}}">{{$farmblock->block_name}}</option>
                                    @endforeach
                                </select>
                                @error('farm_block')
                                <p class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="crop_description" class="form-control" id="exampleFormControlTextarea1" rows="5">{{ old('crop_description') }}</textarea>
                        <!-- error message untuk title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" name="day_min_air_temperature" value="{{ old('day_min_air_temperature') }}" class="form-control @error('min_day_min_air_temperature') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Day Min Air Temp (°C)">
                                <!-- error message untuk title -->
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" name="day_max_air_temperature" value="{{ old('day_max_air_temperature') }}" class="form-control @error('day_max_air_temperature') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Day Max Air Temp (°C)">
                                <!-- error message untuk title -->
                                @error('day_day_max_air_temperature')
                                <p class="mb-3">
                                    {{ $message }}
                                </p>
                                @enderror
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" name="night_min_air_temperature" value="{{ old('night_min_air_temperature') }}" class="form-control @error('night_day_min_air_temperature') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Night Air Temp (°C)">
                                <!-- error message untuk title -->
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" name="night_max_air_temperature" value="{{ old('night_max_air_temperature') }}" class="form-control @error('night_max_air_temperature') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Night Max Air Temp (°C)">
                                <!-- error message untuk title -->
                                @error('day_day_max_air_temperature')
                                <p class="mb-3">
                                    {{ $message }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="exampleInputUsername1" class="form-label">Min Water Temp (°C)</label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="exampleInputUsername1" class="form-label">Max Water Temp(°C)</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="min_growing_time" value="{{ old('min_growing_time')}}" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Min Growing Time">
                                <!-- error message untuk title -->
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="max_growing_time" value="{{ old('max_growing_time') }}" class="form-control @error('max_growing_time') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Max Growing Time">
                                <!-- error message untuk title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nutrient_needs" value="{{ old('nutrient_needs') }}" class="form-control @error('nutrient_needs') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Nutrient Needs">
                                <!-- error message untuk title -->
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="high_risk" value="{{ old('high_risk') }}" class="form-control @error('high_risk') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="High Risk">
                                <!-- error message untuk title -->
                                @error('high_risk')
                                <p class="mb-3">
                                    {{ $message }}
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="disease" value="{{ old('disease') }}" class="form-control @error('disease') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Disease">
                                <!-- error message untuk title -->
                                @error('disease')
                                <p class="mb-3">
                                    {{ $message }}
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="summary" class="form-control" id="exampleFormControlTextarea1" rows="5">{{ old('summary') }}</textarea>
                        <!-- error message untuk title -->
                        @error('summary')
                        <p class="mb-3">
                            {{ $message }}
