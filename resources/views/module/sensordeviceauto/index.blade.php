...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <a href="{{ route('sensor-device-auto.create') }}" class="btn btn-sm btn-success">
          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $sensordevice->device_last_value}}</td>
                  <td>
                    <?php 
                      if($sensordevice->device_status==0) {
                        echo "<p class='alert-danger'>Not Connected</p>"; 
                      }
                      else if($sensordevice->device_status==1) {
                        echo "<p class='alert-success'>Connected</p>"; 
                      }
                    ?>
                  </td>
                  <td class="text-center">
                      <a href="{{ route('sensor-device-auto.edit', $sensordevice->id) }}"
