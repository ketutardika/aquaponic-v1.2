        ...
        <form class="forms-sample" action="{{ route('fishs.update', $fishs->id) }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="Habitat" name="habitat" >
              ...
              <option value="Warm Water" {{ $fishs->habitat == "Warm Water" ? 'selected':'' }}>Warm Water</option>
              <option value="Cold Water"{{ $fishs->habitat == "Cold Water" ? 'selected':'' }}>Cold Water</option>
              <option value="Ornamental"{{ $fishs->habitat == "Ornamental" ? 'selected':'' }}>Ornamental</option>
            </select>
            @error('habitat')
              <p class="mb-3">
                  {{ $message }}
          ...
          <div class="mb-3">
            ...
            <input type="text" name="growth_weeks" value="{{ old('growth_weeks', $fishs->growth_weeks) }}" class="form-control @error('growth_weeks') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Growth Weeks">
            <!-- error message untuk title -->
            @error('growth_weeks')
            <p class="mb-3">
                {{ $message }}
          ...
          <div class="mb-3">
            ...
            <input type="text" name="harvest_weight" value="{{ old('harvest_weight', $fishs->harvest_weight) }}" class="form-control @error('harvest_weight') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Harvest Weight">
            <!-- error message untuk title -->
          ...
          <div class="mb-3">
            ...
            <input type="text" name="daily_feeding_rate" value="{{ old('daily_feeding_rate', $fishs->daily_feeding_rate) }}" class="form-control @error('daily_feeding_rate') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Daily Feeding Rate">
            <!-- error message untuk title -->
          ...
          <div class="mb-3">
            ...
            <input type="number" name="min_protein" value="{{ old('min_protein', $fishs->min_protein) }}" class="form-control @error('min_protein') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Min Protein">
            <!-- error message untuk title -->
            @error('min_protein')
            <p class="mb-3">
                {{ $message }}
          ...
          <div class="mb-3">
            ...
            <input type="number" name="max_protein" value="{{ old('max_protein', $fishs->max_protein) }}" class="form-control @error('max_protein') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Max Protein">
            <!-- error message untuk title -->
            @error('max_protein')
            <p class="mb-3">
                {{ $message }}
          ...
          <div class="mb-3">
            ...
            <input type="number" name="min_dissolved_oxygen" value="{{ old('min_dissolved_oxygen', $fishs->min_dissolved_oxygen) }}" class="form-control @error('min_dissolved_oxygen') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Min Dissolved Oxygen">
            <!-- error message untuk title -->
          ...
          <div class="mb-3">
            ...
            <input type="number" name="max_dissolved_oxygen" value="{{ old('max_dissolved_oxygen', $fishs->max_dissolved_oxygen) }}" class="form-control @error('max_dissolved_oxygen') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Max Dissolved Oxygen">
            <!-- error message untuk title -->
