  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="{{ route('sensor-device.update', $sensordevices->id) }}" method="POST">
          @csrf
          @method('PUT')
          <div class="row">
          <div class="col-md-6">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="SensorActive" name="device_active" >
              <option value="1" {{ $sensordevices->device_active == "1" ? 'selected':'' }}>Active</option>
              <option value="0" {{ $sensordevices->device_active == "0" ? 'selected':'' }}>Not Active</option>
            </select>
            @error('device_active')
              <p class="mb-3">
                  {{ $message }}
